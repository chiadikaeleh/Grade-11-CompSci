...
public class PigBest {
    ...
    public static void main(String[] args) {
        ...
        int compTotal = 0, userTotal = 0, decision = 0, die, compScore = 0,
                userScore = 0, compRolls = 0, start, compRoll, userWins = 0, compWins = 0,
                ties = 0;
        ...
        do {
            ...
            // INVALID MESSAGE
            if (start == 2) {
                System.out.println("If you change your mind, please run again.");
                System.exit(0);
            }
            if (start != 1 && start != 2) {
        ...
        while (playAgain == 1) {
            ...
            do {
                ...
                if (playAgain != 1 && playAgain != 2) {
                    System.out.println("Invalid Option. Yes = 1, No = 2");
                }
            } while (playAgain != 1 && playAgain != 2);
        }
        System.out.println(" ");
        System.out.println("Thank you for playing!");                       // prints reults
        System.out.println(" ");
        System.out.println("----------------------------------------------------------------");
        System.out.println("RESULT:");
        System.out.format("%-6s | %6s | %6s | %6s\n", "Player:", "Wins:", "Losses:", "Ties:");
        System.out.format("%-6s | %6s | %6s | %6s\n", "User:", userWins, compWins, ties);
        System.out.format("%-6s | %6s | %6s | %6s\n", "CPU:", compWins, userWins, ties);
        System.out.println("----------------------------------------------------------------");
        System.exit(0);
    }
}
